...
#ifndef ERIKKSON_ERIKKSON_MUMPS_HPP
#define ERIKKSON_ERIKKSON_MUMPS_HPP
...
public:
    erikkson_mumps(const dimension& trial_x, const dimension& trial_y, const dimension& test_x,
