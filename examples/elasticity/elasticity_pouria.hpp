...
#ifndef ELASTICITY_ELASTICITY_POURIA_HPP
#define ELASTICITY_ELASTICITY_POURIA_HPP
...
private:
    ...
    double& ref(vector_type& v, index_type idx) const { return v(idx[0], idx[1]); }
};
}  // namespace problems

#endif  // ELASTICITY_ELASTICITY_POURIA_HPP
