...
class erikkson_mumps_split : public simulation_2d {
private:
...
private:
    ...
    struct matrix_set {
        lin::band_matrix& MVx, MVy, KVx, KVy;
        lin::dense_matrix& MUVx, MUVy, KUVx, KUVy, AUVx, AUVy;
    };
    ...
    void apply_bc(vector_view& u_rhs) {
