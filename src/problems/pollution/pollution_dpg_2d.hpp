#ifndef PROBLEMS_POLLUTION_DPG_2D_HPP_
#define PROBLEMS_POLLUTION_DPG_2D_HPP_
...
private:
    ...
    void step(int /*iter*/, double /*t*/) override {
        ...
        multiply(MUVx, rhs, rhsx, y.dofs(), "T");
        lin::cyclic_transpose(rhsx, rhsx_t);
    ...
    void compute_rhs_x() {
        ...
        executor.for_each(elements(), [&](index_type e) {
            ...
            for (auto q : quad_points()) {
                double w = weigth(q);
                auto x = point(e, q);
                value_type u = eval(u_prev, e, q, Ux.basis, Uy.basis);
...
#endif /* PROBLEMS_POLLUTION_DPG_2D_HPP_ */
